              ...
              <tr key={p._id || i} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm">
                  <div className="flex flex-col">
                    <span className="font-semibold text-gray-900">{p.parcelName}</span>
                ...
                <td className="px-4 py-3 text-sm font-medium text-gray-900">
                  {p.currency?.toUpperCase() === "USD" ? `$${p.amount}` : `${p.amount} ${p.currency}`}
                </td>

                
                <td className="px-4 py-3 text-sm text-gray-700">{p.customerEmail}</td>
                ...
                <td className="px-4 py-3 text-sm text-gray-600">{fmtDate(p.paidAt)}</td>

                
                <td className="px-4 py-3 text-sm font-mono text-gray-700">{p.trackingId}</td>
          ...
          <div key={p._id || i} className="bg-white shadow rounded-lg p-4">
            <div className="flex justify-between">
              <div className="flex-1 min-w-0">
                <h2 className="text-sm font-semibold text-gray-900">{p.parcelName}</h2>
                <p className="text-xs text-gray-500">{p.parcelId}</p>

                <p className="mt-2 text-sm font-mono text-gray-700 truncate">{p.transactionId}</p>
